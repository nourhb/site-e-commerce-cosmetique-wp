 ...
 */
namespace PopupKitScopedDependencies\Composer;

use PopupKitScopedDependencies\Composer\Autoload\ClassLoader;
use PopupKitScopedDependencies\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('PopupKitScopedDependencies\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
