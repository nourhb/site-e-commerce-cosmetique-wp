...
namespace PopupKitScopedDependencies\Wpmet\UtilityPackage\Helper;
...
class Helper
{
    ...
    {
        return \PopupKitScopedDependencies\Composer\InstalledVersions::getPrettyVersion('wpmet/utility-package');
    }
}
