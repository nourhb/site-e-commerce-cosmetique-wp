...
namespace OptinCraft\WpMVC;

defined('ABSPATH') || exit;
use OptinCraft\DI\Container;
use OptinCraft\WpMVC\Contracts\Provider;
use OptinCraft\WpMVC\Providers\EnqueueServiceProvider;
use OptinCraft\WpMVC\Providers\MigrationServiceProvider;
use OptinCraft\WpMVC\Providers\RouteServiceProvider;
class App
{
