...
namespace OptinCraft\WpMVC\Routing;

defined('ABSPATH') || exit;
use OptinCraft\WpMVC\Routing\Providers\RouteServiceProvider;
use OptinCraft\WpMVC\Routing\Contracts\Middleware as MiddlewareContract;
use WP_Error;
class Middleware
{
