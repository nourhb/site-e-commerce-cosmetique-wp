...
namespace OptinCraft\WpMVC\Database\Eloquent;

defined("ABSPATH") || exit;
use OptinCraft\WpMVC\Database\Eloquent\Relations\BelongsToMany;
use OptinCraft\WpMVC\Database\Eloquent\Relations\BelongsToOne;
use OptinCraft\WpMVC\Database\Eloquent\Relations\HasOne;
