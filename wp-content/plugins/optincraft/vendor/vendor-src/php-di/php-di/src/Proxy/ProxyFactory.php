...
namespace OptinCraft\DI\Proxy;

use OptinCraft\ProxyManager\Configuration;
use OptinCraft\ProxyManager\Factory\LazyLoadingValueHolderFactory;
use OptinCraft\ProxyManager\FileLocator\FileLocator;
use OptinCraft\ProxyManager\GeneratorStrategy\EvaluatingGeneratorStrategy;
use OptinCraft\ProxyManager\GeneratorStrategy\FileWriterGeneratorStrategy;
/**
