...
use function chmod;
use OptinCraft\DI\Definition\ArrayDefinition;
use OptinCraft\DI\Definition\DecoratorDefinition;
...
use OptinCraft\DI\DependencyException;
use OptinCraft\DI\Proxy\ProxyFactoryInterface;
use function dirname;
use function file_put_contents;
use InvalidArgumentException;
use OptinCraft\Laravel\SerializableClosure\Support\ReflectionClosure;
use function rename;
