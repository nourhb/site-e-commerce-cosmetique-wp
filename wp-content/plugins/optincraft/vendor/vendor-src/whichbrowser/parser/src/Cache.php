...
namespace OptinCraft\WhichBrowser;

use OptinCraft\Psr\Cache\CacheItemPoolInterface;
trait Cache
{
    private $cache;
    private $expires;
    ...
    {
        return ['browser' => $this->browser, 'engine' => $this->engine, 'os' => $this->os, 'device' => $this->device, 'camouflage' => $this->camouflage, 'features' => $this->features];
    }
    /**
