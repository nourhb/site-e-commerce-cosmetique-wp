...
namespace OptinCraft\WhichBrowser\Model;

use OptinCraft\WhichBrowser\Model\Browser;
use OptinCraft\WhichBrowser\Model\Engine;
use OptinCraft\WhichBrowser\Model\Os;
...
class Main
{
    ...
    public function isType()
    {
        ...
        for ($a = 0; $a < $count; $a++) {
            ...
            } else if ($arguments[$a] == $this->device->type) {
                return \true;
            }
        }
        return \false;
