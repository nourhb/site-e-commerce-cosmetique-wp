...
use OptinCraft\Laravel\SerializableClosure\Exceptions\InvalidSignatureException;
use OptinCraft\Laravel\SerializableClosure\Exceptions\MissingSecretKeyException;
