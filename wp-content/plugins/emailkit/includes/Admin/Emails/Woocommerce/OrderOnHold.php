...
class OrderOnHold
{
	...
	public function __construct()
	{
		$args = array(
			...
			'meta_query' => array(
				array(
					...
					'value' => EmailLists::ORDER_ON_HOLD,
				),
				array(
		...
		// 
		add_filter('woocommerce_order_status_pending_to_on-hold_notification', [$this, 'onHoldOrder'], 10, 2);
		add_filter('woocommerce_order_status_failed_to_on-hold_notification', [$this, 'onHoldOrder'], 10, 2);
		add_filter('woocommerce_order_status_cancelled_to_on-hold_notification', [$this, 'onHoldOrder'], 10, 2);
	}
	...
	public function onHoldOrder($order_id, $order)
	{
