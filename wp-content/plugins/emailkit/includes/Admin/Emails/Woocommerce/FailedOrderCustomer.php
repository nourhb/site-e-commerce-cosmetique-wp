...
class FailedOrderCustomer {
	...
	public function __construct() {
		...
		$args = array(
			...
			'meta_query' => array(
				array(
					...
					'value' => EmailLists::FAILED_ORDER_CUSTOMER,
				),
				array(
		...
		add_filter('woocommerce_order_status_failed_notification', [$this, 'failedOrder_customer'], 10, 2);
	}

	public function remove_woocommerce_emails($email_class)
	{

		remove_action('woocommerce_order_status_failed_notification', array($email_class->emails['WC_Email_Customer_Failed_Order'], 'trigger'));
	}

	public function failedOrder_customer($order_id, $order)
	{
