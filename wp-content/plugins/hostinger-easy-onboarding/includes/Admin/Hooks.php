...
class Hooks {
    ...
    public function hide_notices() {
        ...
        <style>
            ...
            ?>
            <?php if ( $this->is_onboarding_action_page() ) { ?>
            body::before {
                content: "";
                position: fixed;
                top: 0;
    ...
    public function set_woocommerce_options(): void {
        ...
        if ( $onboarding_choice_done === null && $woocommerce_options_set === null ) {
            $woocommerce_options = new WooCommerceOptions();

            $woocommerce_options->hide_setup_task_list();
            $woocommerce_options->disable_woocommerce_shiping_zone_creation();
            $woocommerce_options->skip_onboarding();
