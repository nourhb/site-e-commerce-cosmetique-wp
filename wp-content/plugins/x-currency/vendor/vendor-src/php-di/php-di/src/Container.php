...
use XCurrency\DI\Definition\Helper\DefinitionHelper;
use XCurrency\DI\Definition\InstanceDefinition;
use XCurrency\DI\Definition\ObjectDefinition;
use XCurrency\DI\Definition\Resolver\DefinitionResolver;
use XCurrency\DI\Definition\Resolver\ResolverDispatcher;
use XCurrency\DI\Definition\Source\DefinitionArray;
use XCurrency\DI\Definition\Source\MutableDefinitionSource;
use XCurrency\DI\Definition\Source\ReflectionBasedAutowiring;
use XCurrency\DI\Definition\Source\SourceChain;
use XCurrency\DI\Definition\ValueDefinition;
use XCurrency\DI\Invoker\DefinitionParameterResolver;
use XCurrency\DI\Proxy\NativeProxyFactory;
use XCurrency\DI\Proxy\ProxyFactory;
use XCurrency\DI\Proxy\ProxyFactoryInterface;
use InvalidArgumentException;
use XCurrency\Invoker\Invoker;
use XCurrency\Invoker\InvokerInterface;
use XCurrency\Invoker\ParameterResolver\AssociativeArrayResolver;
use XCurrency\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
use XCurrency\Invoker\ParameterResolver\DefaultValueResolver;
use XCurrency\Invoker\ParameterResolver\NumericArrayResolver;
use XCurrency\Invoker\ParameterResolver\ResolverChain;
