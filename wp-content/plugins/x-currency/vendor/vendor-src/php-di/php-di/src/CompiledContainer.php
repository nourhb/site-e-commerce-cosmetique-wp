...
use XCurrency\DI\Compiler\RequestedEntryHolder;
use XCurrency\DI\Definition\Definition;
use XCurrency\DI\Definition\Exception\InvalidDefinition;
use XCurrency\DI\Invoker\FactoryParameterResolver;
use XCurrency\Invoker\Exception\NotCallableException;
use XCurrency\Invoker\Exception\NotEnoughParametersException;
